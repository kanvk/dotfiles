...
-- read-only gh_issue/gh_pr pickers (already on <Leader>gHi/I/p/P) with
-- the write actions (create, comment, review, suggest).
--
-- Requires `gh auth login`. Uses snacks as the picker backend (already
